    ...
    <div className="flex justify-center mt-[10vh] text-base sm:text-lg text-slate-600">
      <div className="border-2 border-gray-400 rounded-lg p-6 w-[400px]">
        {currState === "Login" ? (
          ...
          <h1 className="text-2xl font-medium text-black">SignUp</h1>
        )}
        <p>
          Please {currState === "Login" ? `login` : `sign up`} to book
          appointment
        </p>
        ...
        <form onSubmit={submitHandler}>
          {currState != "Login" ? (
            <div className="my-3 w-full">
              ...
              <input
                type="text"
                className="outline outline-gray-400 mt-2 rounded-sm py-2 px-4 block  w-full "
                onChange={(e) => {
          ...
          <div className="my-3 w-full">
            <label htmlFor="email" className="text-lg sm:text-xl text-gray-800">
              Email
            </label>
            <input
              type="text"
          ...
          {currState === "Login" ? (
            <button className="bg-[#5f6FFF] text-center py-1 rounded-sm w-full text-white my-2">
              Login
            </button>
          ) : (
            <button className="bg-[#5f6FFF] text-center py-1 rounded-sm w-full text-white my-2">
